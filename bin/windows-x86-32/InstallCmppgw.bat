...
rem set _WRAPPER_CONF="%_REALPATH%..\..\conf\wrapper.conf"
set _WRAPPER_CONF="%CMPPGW_HOME%\conf\wrapper.conf"

set _CMPPGW_HOME="set.CMPPGW_HOME=%CMPPGW_HOME%"

rem
rem Install the Wrapper as an NT service.
rem
:startup
"%_WRAPPER_EXE%" -i %_WRAPPER_CONF% %_CMPPGW_HOME%
